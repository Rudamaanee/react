  ...
  const options = {
    ...
    accessibility: {
      description: 'A tile map represents the states of the USA by ' +
        'population in 2016. The hexagonal tiles are positioned to ' +
        ...
        'population of above 20 million: California (39.3 million), ' +
...
export default Tilemaphoneycomb;